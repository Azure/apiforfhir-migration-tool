...
namespace FhirMigrationTool.Test
{
    internal static class TestHelpers
    {
        ...
        internal static string MockExportStatusResponse => File.ReadAllText("../../../mock_export_status_response.json");

        internal static string MockImportStatusResponse => File.ReadAllText("../../../mock_import_status_response.json");

        internal static string TestImportBody => File.ReadAllText("../../../import_body.json");
